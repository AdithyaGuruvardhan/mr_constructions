...
export default function InspiringDesignSection() {
  ...
  return (
    <section ref={pinContainerRef} className="relative w-full bg-[#fff4e9]/50 overflow-hidden flex flex-col justify-start lg:h-screen lg:flex-row lg:items-center">
      <style>
        {`
