      ...
      <div ref={trackRef} className="flex flex-col lg:flex-row w-full lg:w-max h-full">
        ...
        <div className="w-full lg:w-[100vw] h-full flex items-center px-6 md:px-12 py-12 lg:py-0 shrink-0">
          <div className="max-w-[1600px] mx-auto w-full relative z-10 flex flex-col xl:flex-row h-full items-center justify-start xl:gap-16 gap-12">
            ...
            {/* Main Center Image */}
            <div className="w-full sm:w-[80%] md:w-[60%] xl:w-[35%] z-20 shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden relative xl:-translate-x-4 group">
              <img src="/temple/MELKOTE KALYANI3.jpg" alt="Melkote Kalyani Main" className="w-full aspect-[4/5] md:aspect-[3/4] object-cover group-hover:scale-105 transition-transform duration-[2s]" />
        ...
        <div className="w-full lg:w-[100vw] h-full flex flex-col lg:flex-row justify-between px-6 md:px-12 py-12 lg:py-16 shrink-0 gap-12">
          ...
          <div className="w-full lg:w-[35vw] h-auto lg:h-full flex flex-col justify-between items-start lg:-mb-16">
            ...
            <div className="hidden lg:flex relative items-center justify-center w-28 h-28 md:w-32 md:h-32 rounded-full cursor-pointer hover:scale-105 transition-transform duration-300 group mt-8 md:mt-12 lg:mt-0 xl:mt-8 -ml-20">
              {/* Center Text */}
            ...
            <div className="w-full sm:w-[70%] lg:w-[65%] shadow-[0_1px_5px_rgba(0,0,0,0.3)] overflow-hidden relative group mt-8 lg:mt-auto">
              <img src="/temple/MELKOTE KALYANI19.jpg" alt="Melkote Kalyani detail" className="w-full aspect-[4/5] lg:aspect-[3/4] object-cover group-hover:scale-105 transition-transform duration-[1.5s]" />
          ...
          <div className="w-full lg:w-[45vw] h-auto lg:h-full flex flex-col justify-start lg:items-end -mt-10 pb-12 lg:pb-0 lg:-translate-x-12 xl:-translate-x-20">
            ...
            <div className="w-full lg:w-[90%] shadow-[0_1px_20px_rgba(0,0,0,0.3)] overflow-hidden relative group">
              <img src="/temple/MELKOTE KALYANI16.jpg" alt="Melkote Kalyani structure" className="w-full aspect-[16/10] object-cover group-hover:scale-105 transition-transform duration-[1.5s]" />
              <div className="absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors duration-500"></div>
            </div>

            {/* Text Below (Offset towards center) */}
            <div className="w-full lg:w-[95%] mt-12 lg:mt-20 self-start flex flex-col gap-8">
               <h3 className="font-editorial text-[1.5rem] lg:text-[2.2rem] text-[#1c1c1e] leading-[1.1] uppercase text-center lg:text-left">
