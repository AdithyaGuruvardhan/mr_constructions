          ...
          >
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <div className="pt-6 border-t border-gray-100 pointer-events-none flex items-center justify-between">
                  <div>
                  ...
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gray-100 flex items-center justify-center shrink-0 border border-gray-200">
                    <svg className="w-6 h-6 md:w-7 md:h-7 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
