...
const features = [
  ...
  },
  {
    ...
    description: "Our diverse project portfolio across various sectors highlights our extensive construction expertise."
  },
  {
    title: "Safety",
...
export default function WhyChooseUsSection() {
  ...
  return (
    <section ref={containerRef} className="relative w-full bg-[#fcfcfc] pt-20 pb-16 md:pt-[14rem] md:pb-12 overflow-hidden font-sans">
      ...
      <div className="max-w-8xl mx-auto px-8 md:px-16 relative z-10">
