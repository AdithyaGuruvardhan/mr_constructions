  ...
  return (
    <div className="pt-32 pb-20 px-6 md:px-16 min-h-screen flex flex-col items-center justify-center bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-[40vw] h-[40vw] rounded-full bg-green-100 opacity-40 blur-3xl"></div>
        <div className="absolute bottom-[-10%] left-[-5%] w-[30vw] h-[30vw] rounded-full bg-emerald-100 opacity-40 blur-3xl"></div>
      </div>

      <div className="max-w-5xl mx-auto text-center w-full relative z-10">
        <Link to="/portfolio" className="inline-flex items-center text-sm font-semibold text-green-600 mb-6 hover:text-green-800 transition-colors">
