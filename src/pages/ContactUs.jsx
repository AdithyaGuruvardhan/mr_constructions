    ...
    <div className="relative w-full min-h-screen bg-white text-[#2d2d2d] pt-32 sm:pt-40 md:pt-[18rem] pb-20 font-sans overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col gap-16 md:gap-24">
          ...
          {/* Contact Form */}
          <div className="bg-gray-200 p-6 sm:p-8 md:p-16 rounded-[2rem] border border-gray-200 flex flex-col lg:flex-row justify-between w-full gap-8 lg:gap-16 relative overflow-hidden">
